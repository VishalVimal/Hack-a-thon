...
export default function Auth() {
    ...
    const handleAuth = async (e) => {
        ...
        try {
            ...
            // If signup success, create profile
            if (data.user && !isLogin) {
                ...
                alert(`${role === 'recruiter' ? 'Recruiter' : 'Candidate'} account created successfully! You can now login.`)
                if (data.session) navigate('/dashboard')
            } else if (data.session) {
                // For login, verify the user has a profile
                ...
                console.log(`Logging in as ${profile.role}`)
                navigate('/dashboard')
            }
                    ...
                    {!isLogin && (
                        <>
                            ...
                            >
                                ...
                                Sign up with Google as {role === 'recruiter' ? 'Recruiter' : 'Candidate'}
                            </button>
                        </>
                    )}
                </form>
